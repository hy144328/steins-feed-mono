...
import type { LoginTokenPostData, LoginTokenPostError, LoginTokenPostResponse, TagsFeedsTagsGetError, TagsFeedsTagsGetResponse, LanguagesFeedsLanguagesGetError, LanguagesFeedsLanguagesGetResponse, FeedFeedsFeedFeedIdGetData, FeedFeedsFeedFeedIdGetError, FeedFeedsFeedFeedIdGetResponse, AttachTagFeedsFeedFeedIdAttachTagPutData, AttachTagFeedsFeedFeedIdAttachTagPutError, AttachTagFeedsFeedFeedIdAttachTagPutResponse, DetachTagFeedsFeedFeedIdDetachTagDeleteData, DetachTagFeedsFeedFeedIdDetachTagDeleteError, DetachTagFeedsFeedFeedIdDetachTagDeleteResponse, CreateAndAttachTagFeedsFeedFeedIdCreateAndAttachTagPutData, CreateAndAttachTagFeedsFeedFeedIdCreateAndAttachTagPutError, CreateAndAttachTagFeedsFeedFeedIdCreateAndAttachTagPutResponse, AttachUserFeedsFeedFeedIdAttachUserPutData, AttachUserFeedsFeedFeedIdAttachUserPutError, AttachUserFeedsFeedFeedIdAttachUserPutResponse, DetachUserFeedsFeedFeedIdDetachUserDeleteData, DetachUserFeedsFeedFeedIdDetachUserDeleteError, DetachUserFeedsFeedFeedIdDetachUserDeleteResponse, UpdateFeedFeedsFeedFeedIdUpdateFeedPostData, UpdateFeedFeedsFeedFeedIdUpdateFeedPostError, UpdateFeedFeedsFeedFeedIdUpdateFeedPostResponse, RootItemsGetData, RootItemsGetError, RootItemsGetResponse, LikeItemsLikePutData, LikeItemsLikePutError, LikeItemsLikePutResponse, AnalyzeTitleItemsAnalyzeTitleGetData, AnalyzeTitleItemsAnalyzeTitleGetError, AnalyzeTitleItemsAnalyzeTitleGetResponse, AnalyzeSummaryItemsAnalyzeSummaryGetData, AnalyzeSummaryItemsAnalyzeSummaryGetError, AnalyzeSummaryItemsAnalyzeSummaryGetResponse, RootGetError, RootGetResponse } from './types.gen';
 ...
 * Attach User
 */
export const attachUserFeedsFeedFeedIdAttachUserPut = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<AttachUserFeedsFeedFeedIdAttachUserPutData, ThrowOnError>) => {
    return (options?.client ?? client).put<AttachUserFeedsFeedFeedIdAttachUserPutResponse, AttachUserFeedsFeedFeedIdAttachUserPutError, ThrowOnError>({
        ...options,
 ...
 * Detach User
 */
export const detachUserFeedsFeedFeedIdDetachUserDelete = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<DetachUserFeedsFeedFeedIdDetachUserDeleteData, ThrowOnError>) => {
    return (options?.client ?? client).delete<DetachUserFeedsFeedFeedIdDetachUserDeleteResponse, DetachUserFeedsFeedFeedIdDetachUserDeleteError, ThrowOnError>({
        ...options,
 ...
 * Update Feed
 */
export const updateFeedFeedsFeedFeedIdUpdateFeedPost = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateFeedFeedsFeedFeedIdUpdateFeedPostData, ThrowOnError>) => {
    return (options?.client ?? client).post<UpdateFeedFeedsFeedFeedIdUpdateFeedPostResponse, UpdateFeedFeedsFeedFeedIdUpdateFeedPostError, ThrowOnError>({
        ...options,
 ...
 * Analyze Title
 */
export const analyzeTitleItemsAnalyzeTitleGet = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<AnalyzeTitleItemsAnalyzeTitleGetData, ThrowOnError>) => {
    return (options?.client ?? client).get<AnalyzeTitleItemsAnalyzeTitleGetResponse, AnalyzeTitleItemsAnalyzeTitleGetError, ThrowOnError>({
        ...options,
 ...
 * Analyze Summary
 */
export const analyzeSummaryItemsAnalyzeSummaryGet = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<AnalyzeSummaryItemsAnalyzeSummaryGetData, ThrowOnError>) => {
    return (options?.client ?? client).get<AnalyzeSummaryItemsAnalyzeSummaryGetResponse, AnalyzeSummaryItemsAnalyzeSummaryGetError, ThrowOnError>({
        ...options,
