 ...
 * Detach Tag
 */
export const detachTagFeedsFeedFeedIdDetachTagPut = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<DetachTagFeedsFeedFeedIdDetachTagPutData, ThrowOnError>) => {
    return (options?.client ?? client).put<DetachTagFeedsFeedFeedIdDetachTagPutResponse, DetachTagFeedsFeedFeedIdDetachTagPutError, ThrowOnError>({
        ...options,
