 ...
 * Analyze Text
 */
export const analyzeTextItemsAnalyzeTextGet = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<AnalyzeTextItemsAnalyzeTextGetData, ThrowOnError>) => {
    return (options?.client ?? client).get<AnalyzeTextItemsAnalyzeTextGetResponse, AnalyzeTextItemsAnalyzeTextGetError, ThrowOnError>({
        ...options,
        url: '/items/analyze_text'
    });
};
